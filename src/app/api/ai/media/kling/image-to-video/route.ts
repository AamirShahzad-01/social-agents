...
/**
 * POST /api/ai/media/kling/image-to-video
 * Generate video from image using Kling AI v2.6
 */
export async function POST(request: NextRequest) {
    try {
        ...
        try {
            const backendResponse = await fetch(`${PYTHON_BACKEND_URL}/api/v1/media/kling/image-to-video`, {
                method: 'POST',
                headers: {
