...
/**
 * POST /api/ai/media/kling/text-to-video
 * Generate video from text prompt using Kling AI v2.6
 */
export async function POST(request: NextRequest) {
    try {
        ...
        try {
            const backendResponse = await fetch(`${PYTHON_BACKEND_URL}/api/v1/media/kling/text-to-video`, {
                method: 'POST',
                headers: {
