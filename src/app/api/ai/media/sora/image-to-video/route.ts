...
/**
 * POST /api/ai/media/sora/image-to-video
...
export async function POST(request: NextRequest) {
    try {
        ...
        try {
            const backendResponse = await fetch(`${PYTHON_BACKEND_URL}/api/v1/media/sora/image-to-video`, {
                method: 'POST',
                headers: {
        ...
        console.error('Sora image-to-video error:', error);
